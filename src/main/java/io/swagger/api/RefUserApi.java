...
public interface RefUserApi {
    ...
    ResponseEntity<Void> createUser(@ApiParam(value = "токен пользователя" ,required=true) @RequestHeader(value="x-request-token", required=true) String xRequestToken,@ApiParam(value = "Создание пользователя" ,required=true )  @Valid @RequestBody RefUser body);
    ...
    ResponseEntity<List<RefUser>> refUserGet(@ApiParam(value = "токен пользователя" ,required=true) @RequestHeader(value="x-request-token", required=true) String xRequestToken,@ApiParam(value = "id пользователя.") @Valid @RequestParam(value = "id", required = false) Integer id);
