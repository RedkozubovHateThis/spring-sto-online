...
public interface ReportService {
    ...
    byte[] getExecutorsReportPDF(Integer organizationId, Date startDate, Date endDate) throws IOException, JRException, DataNotFoundException;

    byte[] getClientsReport(Integer organizationId, Date startDate, Date endDate) throws IOException, DataNotFoundException;
    byte[] getClientsReportPDF(Integer organizationId, Date startDate, Date endDate) throws IOException, JRException, DataNotFoundException;
